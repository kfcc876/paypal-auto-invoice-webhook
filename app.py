...
def create_and_send_invoice(payer_email, amount, currency="USD"):
    ...
    # 2. Send Invoice (This triggers the email and "Receipt" status)
...
def paypal_webhook():
    ...
    # We listen for captured payments (standard way people send money)
...
def health_check():
    return "PayPal Auto-Invoice Bot is Running!", 200
